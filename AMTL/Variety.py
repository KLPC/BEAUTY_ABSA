...
class MultiABSA(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.big_cat =  nn.ModuleDict({ f'cat{i}':create_layer(config['drop_2'], config['shared_dim2'], config['shared_dim3'])
                                       for i in range (1, 6) })

        ## TASK Specific Network - MID (제품군)
        self.mid_cat = nn.ModuleDict({ f'task{i}':create_layer(config['drop_3'], config['shared_dim3'], config[f'task{i}'])
                                       for i in range (1, 10) })
    ...
    def forward (self, docs, doc_lengths):
        ...
        u_1 = torch.tanh(self.sent_att.cat1(h_i_normed.data))
        u_2 = torch.tanh(self.sent_att.cat2(h_i_normed.data))
        u_3 = torch.tanh(self.sent_att.cat3(h_i_normed.data))
        u_4 = torch.tanh(self.sent_att.cat4(h_i_normed.data))
        u_5 = torch.tanh(self.sent_att.cat5(h_i_normed.data))

        # attention for doc_vec
        att11, att12, att13 = self.get_att_vec3(self.task_cv.task1, u_1, valid_bsz_sent )
        att21, att22, att23 = self.get_att_vec3(self.task_cv.task2, u_1, valid_bsz_sent )
        att31, att32, att33 = self.get_att_vec3(self.task_cv.task3, u_1, valid_bsz_sent )
        att41, att42, att43 = self.get_att_vec3(self.task_cv.task4, u_2, valid_bsz_sent )
        att51, att52, att53, att54, att55, att56 = self.get_att_vec6(self.task_cv.task5, 
                                                               u_3, valid_bsz_sent )
        att61, att62, att63 = self.get_att_vec3(self.task_cv.task6, u_4, valid_bsz_sent )
        att71, att72, att73 = self.get_att_vec3(self.task_cv.task7, u_4, valid_bsz_sent )
        att81, att82, att83 = self.get_att_vec3(self.task_cv.task8, u_5, valid_bsz_sent )
        att91, att92, att93 = self.get_att_vec3(self.task_cv.task9, u_5, valid_bsz_sent )
        ...
        ts11 = self.mid_cat.task1(self.big_cat.cat1(self.big_shared(self.shared_layer1(doc11[doc_unperm_idx]))))
        ts12 = self.mid_cat.task1(self.big_cat.cat1(self.big_shared(self.shared_layer1(doc12[doc_unperm_idx]))))
        ts13 = self.mid_cat.task1(self.big_cat.cat1(self.big_shared(self.shared_layer1(doc13[doc_unperm_idx]))))
        ts21 = self.mid_cat.task2(self.big_cat.cat1(self.big_shared(self.shared_layer1(doc21[doc_unperm_idx]))))
        ts22 = self.mid_cat.task2(self.big_cat.cat1(self.big_shared(self.shared_layer1(doc22[doc_unperm_idx]))))
        ts23 = self.mid_cat.task2(self.big_cat.cat1(self.big_shared(self.shared_layer1(doc23[doc_unperm_idx]))))
        ts31 = self.mid_cat.task3(self.big_cat.cat1(self.big_shared(self.shared_layer1(doc31[doc_unperm_idx]))))
        ts32 = self.mid_cat.task3(self.big_cat.cat1(self.big_shared(self.shared_layer1(doc32[doc_unperm_idx]))))
        ts33 = self.mid_cat.task3(self.big_cat.cat1(self.big_shared(self.shared_layer1(doc33[doc_unperm_idx]))))

        ts41 = self.mid_cat.task4(self.big_cat.cat2(self.big_shared(self.shared_layer1(doc41[doc_unperm_idx]))) )
        ts42 = self.mid_cat.task4(self.big_cat.cat2(self.big_shared(self.shared_layer1(doc42[doc_unperm_idx]))) )
        ts43 = self.mid_cat.task4(self.big_cat.cat2(self.big_shared(self.shared_layer1(doc43[doc_unperm_idx]))) )
        
        ts51 = self.mid_cat.task5(self.big_cat.cat3(self.big_shared(self.shared_layer1(doc51[doc_unperm_idx]))) )
        ts52 = self.mid_cat.task5(self.big_cat.cat3(self.big_shared(self.shared_layer1(doc52[doc_unperm_idx]))) )
        ts53 = self.mid_cat.task5(self.big_cat.cat3(self.big_shared(self.shared_layer1(doc53[doc_unperm_idx]))) )
        ts54 = self.mid_cat.task5(self.big_cat.cat3(self.big_shared(self.shared_layer1(doc54[doc_unperm_idx]))) )
        ts55 = self.mid_cat.task5(self.big_cat.cat3(self.big_shared(self.shared_layer1(doc55[doc_unperm_idx]))) )
        ts56 = self.mid_cat.task5(self.big_cat.cat3(self.big_shared(self.shared_layer1(doc56[doc_unperm_idx]))) )
        
        ts61 = self.mid_cat.task6(self.big_cat.cat4(self.big_shared(self.shared_layer1(doc61[doc_unperm_idx]))) )
        ts62 = self.mid_cat.task6(self.big_cat.cat4(self.big_shared(self.shared_layer1(doc62[doc_unperm_idx]))) )
        ts63 = self.mid_cat.task6(self.big_cat.cat4(self.big_shared(self.shared_layer1(doc63[doc_unperm_idx]))) )
        ts71 = self.mid_cat.task7(self.big_cat.cat4(self.big_shared(self.shared_layer1(doc71[doc_unperm_idx]))) )
        ts72 = self.mid_cat.task7(self.big_cat.cat4(self.big_shared(self.shared_layer1(doc72[doc_unperm_idx]))) )
        ts73 = self.mid_cat.task7(self.big_cat.cat4(self.big_shared(self.shared_layer1(doc73[doc_unperm_idx]))) )
        
        ts81 = self.mid_cat.task8(self.big_cat.cat5(self.big_shared(self.shared_layer1(doc81[doc_unperm_idx]))) )
        ts82 = self.mid_cat.task8(self.big_cat.cat5(self.big_shared(self.shared_layer1(doc82[doc_unperm_idx]))) )
        ts83 = self.mid_cat.task8(self.big_cat.cat5(self.big_shared(self.shared_layer1(doc83[doc_unperm_idx]))) )
        ts91 = self.mid_cat.task9(self.big_cat.cat5(self.big_shared(self.shared_layer1(doc91[doc_unperm_idx]))) )
        ts92 = self.mid_cat.task9(self.big_cat.cat5(self.big_shared(self.shared_layer1(doc92[doc_unperm_idx]))) )
        ts93 = self.mid_cat.task9(self.big_cat.cat5(self.big_shared(self.shared_layer1(doc93[doc_unperm_idx]))) )
