...
config['drop_3'] = 0.1
config['drop_4'] = 0.1
config['shared_dim1'] = 256
config['shared_dim2'] = 128
config['shared_dim3'] = 64
config['shared_dim4'] = 32
config['shared_dim5'] = 32
